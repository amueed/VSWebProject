<%@ Page Title="" Language="C#" MasterPageFile="~/myeisc_admin/Admin.master" AutoEventWireup="true" CodeFile="CreateHomePageProject.aspx.cs" Inherits="myeisc_admin_Default2" %>
...
Create Project to display on Home Page
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:SqlDataSource ID="create_Project" runat="server" 
        ...
        DeleteCommand="DELETE FROM [homepageProjects] WHERE [id] = @id" 
        InsertCommand="INSERT INTO [homepageProjects] ([title], [description], [pic]) VALUES (@title, @description, @pic)" 
        SelectCommand="SELECT * FROM [homepageProjects] WHERE [id] = @id" 
        
        UpdateCommand="UPDATE [homepageProjects] SET [title] = @title, [description] = @description, [pic] = @pic WHERE [id] = @id">
        <DeleteParameters>
